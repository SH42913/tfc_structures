...
public final class PresetContainer {
    ...
    private static @NotNull List<ReplacementPreset.Direct> getDefaultDirect() {
        ...
        list.add(new ReplacementPreset.Direct("minecraft:polished_deepslate_wall", "tfc:rock/smooth/basalt_wall"));
        list.add(new ReplacementPreset.Direct("minecraft:deepslate_bricks", "tfc:rock/bricks/basalt"));
        list.add(new ReplacementPreset.Direct("minecraft:deepslate_brick_stairs", "tfc:rock/bricks/basalt_stairs"));
        list.add(new ReplacementPreset.Direct("minecraft:deepslate_brick_slab", "tfc:rock/bricks/basalt_slab"));
        list.add(new ReplacementPreset.Direct("minecraft:deepslate_brick_wall", "tfc:rock/bricks/basalt_wall"));
        list.add(new ReplacementPreset.Direct("minecraft:deepslate_tiles", "tfc:rock/bricks/basalt"));
        list.add(new ReplacementPreset.Direct("minecraft:deepslate_tile_stairs", "tfc:rock/bricks/basalt_stairs"));
        list.add(new ReplacementPreset.Direct("minecraft:deepslate_tile_slab", "tfc:rock/bricks/basalt_slab"));
        list.add(new ReplacementPreset.Direct("minecraft:deepslate_tile_wall", "tfc:rock/bricks/basalt_wall"));
        list.add(new ReplacementPreset.Direct("minecraft:cracked_deepslate_bricks", "tfc:rock/cracked_bricks/basalt"));
        list.add(new ReplacementPreset.Direct("minecraft:cracked_deepslate_tiles", "tfc:rock/cracked_bricks/basalt"));
        list.add(new ReplacementPreset.Direct("minecraft:chiseled_deepslate", "tfc:rock/chiseled/basalt"));
    ...
    private static @NotNull List<ReplacementPreset.TFCWorld> getDefaultTFCWorld() {
        ...
        var woodBlocksSet = Set.of(Blocks.CRAFTING_TABLE, Blocks.CHEST, Blocks.TRAPPED_CHEST, Blocks.BOOKSHELF, Blocks.CHISELED_BOOKSHELF);
